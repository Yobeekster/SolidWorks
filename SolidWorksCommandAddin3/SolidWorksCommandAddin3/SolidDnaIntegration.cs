...
namespace SolidWorksCommandAddin3
{
    /// <summary>
    ...
    public class MySolidDnaPlugin : SolidPlugIn
    {
        ...
        /// </summary>
        public override string AddInDescription { get { return "Contains various custom commands"; } }

        /// <summary>
        /// My Add-in title
        /// </summary>
        public override string AddInTitle { get { return "SolidWorks Command Addin"; } }
